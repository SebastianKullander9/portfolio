...
export default function Card({ id, title, text, tags }: CardProps ) {
    return (
        <div className="w-61 h-90 sm:w-82 sm:h-120 lg:w-96 lg:h-140 xl:w-110 xl:h-160 bg-[var(--color-offwhite)]/25 rounded-3xl p-4 sm:p-6 md:p-8 lg:p-10 xl:p-12 flex flex-col justify-between mt-5">
            <div className="flex flex-col gap gap-8">
                <div className="flex flex-row justify-between text-lg xl:text-3xl font-medium text-white">
                    <h1>{title}</h1>
                    <h1>{id}</h1>
                </div>
                <div className="site-text-size text-white">
                    <p>{text}</p>
                </div>
            </div>
            <div className="flex flex-col gap-2 site-text-size text-white">
